    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="lg:ml-[260px] pt-[64px] lg:pt-0 p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <Link to="/dashboard/my-pets/new" className="shrink-0">
            <Button variant="primary" icon={Plus}>List a Pet</Button>
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 py-20 text-center">
            ...
            <Link to="/dashboard/my-pets/new">
              <Button variant="outline" size="sm">List Your First Pet</Button>
            </Link>
          </div>
        ) : (
